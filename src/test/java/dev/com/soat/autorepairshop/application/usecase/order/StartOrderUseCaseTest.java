...
class StartOrderUseCaseTest {
    ...
    @Test
    @DisplayName("Deve iniciar execução do ordem de serviço com sucesso quando ordem de serviço estiver aprovado")
    void shouldStartOrderExecutionSuccessfullyWhenOrderIsApproved() {
        // Given
        ...
        // When/Then
        assertDoesNotThrow(() -> startOrderUseCase.execute(orderId, employeeId));
        ...
        assertEquals(OrderStatusType.EM_EXECUCAO, order.getStatus());
    }

    @Test
    @DisplayName("Deve lançar DomainException quando ordem de serviço não estiver aprovado - status RECEBIDA")
    void shouldThrowDomainExceptionWhenOrderIsNotApproved_StatusReceived() {
        // Given
        final Long orderId = 1L;
        final Long employeeId = 10L;
        final var order = OrderDomain.restore(
        ...
        DomainException exception = assertThrows(
                ...
                () -> startOrderUseCase.execute(orderId, employeeId)
        );
    ...
    @Test
    @DisplayName("Deve lançar DomainException quando ordem de serviço não estiver aprovado - status EM_DIAGNOSTICO")
    void shouldThrowDomainExceptionWhenOrderIsNotApproved_StatusInDiagnosis() {
        // Given
        final Long orderId = 1L;
        final Long employeeId = 10L;
        final var order = OrderDomain.restore(
    ...
    @Test
    @DisplayName("Deve lançar DomainException quando ordem de serviço não estiver aprovado - status EM_EXECUCAO")
    void shouldThrowDomainExceptionWhenOrderIsNotApproved_StatusInExecution() {
        // Given
        final Long orderId = 1L;
        final Long employeeId = 10L;
        final var order = OrderDomain.restore(
    ...
    @Test
    @DisplayName("Deve lançar DomainException quando ordem de serviço não estiver aprovado - status FINALIZADA")
    void shouldThrowDomainExceptionWhenOrderIsNotApproved_StatusFinished() {
        // Given
        final Long orderId = 1L;
        final Long employeeId = 10L;
        final var order = OrderDomain.restore(
    ...
    @Test
    @DisplayName("Deve lançar DomainException quando ordem de serviço não estiver aprovado - status ENTREGUE")
    void shouldThrowDomainExceptionWhenOrderIsNotApproved_StatusDelivered() {
        // Given
        final Long orderId = 1L;
        final Long employeeId = 10L;
        final var order = OrderDomain.restore(
